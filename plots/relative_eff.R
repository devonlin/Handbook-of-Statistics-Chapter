...
M_c0_value=matrix(NA,ncol=6,nrow=P)
colnames(M_c0_value)=c("oneshot","ARSD","RCC","ECL","EI","LCB")
...
relative_eff=matrix(NA,ncol=5,nrow=P)
colnames(relative_eff)=c("ARSD","RCC","ECL","EI","LCB")
relative_eff[,1]=R5
relative_eff[,2]=R2
#relative_eff[,3]=R1
relative_eff[,3]=R3
...
M_c0_table=cbind(M_c0_value[,1:2],relative_eff[,1],M_c0_value[,3],
                 relative_eff[,2],M_c0_value[,4],relative_eff[,3],
                 M_c0_value[,5],relative_eff[,4],M_c0_value[,6],relative_eff[,5])
colnames(M_c0_table)=c("oneshot","ARSD","R5","RCC","R2","ECL","R3","EI","R4","LCB","R6")
